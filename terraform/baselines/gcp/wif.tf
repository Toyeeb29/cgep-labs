...
resource "google_iam_workload_identity_pool_provider" "github" {
  ...
  attribute_condition = "assertion.repository == \"Toyeeb29/cgep-labs\""
...
resource "google_service_account_iam_binding" "wif_user" {
  ...
  members = [
    "principalSet://iam.googleapis.com/${google_iam_workload_identity_pool.github.name}/attribute.repository/Toyeeb29/cgep-labs",
  ]
}